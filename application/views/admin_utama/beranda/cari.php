...
<!-- end notifikasi -->
 ...
 <script src="https://unpkg.com/leaflet@1.6.0/dist/leaflet.js"
   ...
   <script type="text/javascript">
    ...
    <?php foreach ($data_ukmcari as $key => $value){?>
        L.marker([<?= $value->latitude;?>, <?= $value->longtitude;?>],{icon:iconlogo})
        .bindPopup("<div><center><h4><?= $value->nama_usaha;?></h4><br><img src='<?= base_url();?>assets/admin/icon/<?= $value->photo;?>' width='200px' height='150px'><br><br><a href='<?= $value->link_usaha;?>' class='btn bg-purple margin' style='font-size:20px' target='_blank'><i class='fa fa-mail-forward'> Telusuri...</i></a></div>")
        .bindTooltip("<img src='<?= base_url();?>assets/admin/icon/<?= $value->photo;?>' width='100px' height='50px'><br><table><tr><td>Nama Usaha</td><td>: <?= $value->nama_usaha;?></td></tr><tr><td>Handphone</td><td>: <?= $value->handphone;?></td></tr></table><br>").openTooltip()
        .addTo(mymap);  
    <?php } ?>
      ...
      .bindPopup("<center><img src='<?= base_url();?>assets/admin/icon/factory.svg' width='200px' height='150px'><br><h4>Persebaran Data UKM</h4><br>Provinsi Sumatera Selatan")
      .openPopup();
